...
const username = "shai1"; // replace with your username
const password = "shai1"; // replace with your password
...
async function createAllPosts() {
  console.log(
    `Starting to create ${polygonPosts.length} Polygon PM posts in Circle 59...`,
  );
