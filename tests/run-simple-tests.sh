...
# From project root, use a clear, direct approach
echo "🔄 Running authentication tests..."
npx jest tests/api/auth-endpoints.test.cjs

echo ""
echo "🔄 Running data creation tests..."
npx jest tests/api/data-creation.test.cjs

echo ""
echo "🔄 Running circle operations tests..."
npx jest tests/api/circles-api.test.cjs

echo ""
echo "🔄 Running AI follower tests..."
npx jest tests/api/followers-api.test.cjs

echo ""
echo "🔄 Running essential workflow test..."
npx jest tests/api/workflow.test.cjs -t "Update profile"

echo ""
echo "✅ Essential tests completed."
echo "For more comprehensive testing, run individual test files directly:"
echo "npx jest tests/api/posts-api.test.cjs"