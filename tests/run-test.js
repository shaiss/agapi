 ...
 * To use: node tests/run-test.js <test-file-path>
 * Example: node tests/run-test.js api/posts-api.test.cjs
 */
...
function runTest() {
  ...
  if (args.length === 0) {
    ...
    console.log('Example: node run-test.js api/posts-api.test.cjs');
    process.exit(1);
  }
